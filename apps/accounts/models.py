...
class BanLog(models.Model):
    """
    Model to log user bans.
    """
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="ban_logs"
    )
...
def ensure_profile_exists(sender, instance: User, created: bool, **kwargs):
    """
    Signal to create or get a profile when a User is saved.
    """
