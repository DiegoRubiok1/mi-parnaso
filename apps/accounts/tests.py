...
class AccountsTests(TestCase):
	...
	def test_logout_with_post_works(self):
		user = User.objects.create_user(username="ana2", email="ana2@example.com", password="StrongPass123!")
	...
	def test_logout_with_get_is_not_allowed(self):
		user = User.objects.create_user(username="ana3", email="ana3@example.com", password="StrongPass123!")
		self.client.force_login(user)
